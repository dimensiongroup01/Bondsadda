<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="FAQCategory.aspx.cs" Inherits="Admin_FAQCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">ADD FAQ CACEGORY</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">ADD FAQ CATEGORY</a></li>
                                    ...
                                    <div class="live-preview">
                                        <div action="javascript:void(0);">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="firstNameinput" class="form-label">FAQ Category*</label>
                                                        <asp:TextBox ID ="txtFAQCategory" runat="server" class="form-control" placeholder="FAQ Category"></asp:TextBox>
                                                    </div>
                                                </div>
            ...
            <asp:LinkButton ID="lnkAdd" runat="server" CssClass="btn btn-primary" OnClick="lnkAdd_Click" >Add FAQ Category</asp:LinkButton>
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="col-md-12" runat="server" id="Div3">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="FAQ Category" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                        ...
                                        <ItemTemplate>
                                              <asp:CheckBox ID="chkIsActive"  runat="server" Checked='<%#Eval("IsActive")%>' ToolTip='<%#Eval("FAQCategoryId")%>'
                                                        OnCheckedChanged="chkIsActive_CheckedChanged" AutoPostBack="true" />
                                 <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%#Eval("FAQCategoryId")%>' OnClick="lnkEdit_Click">
                                        ...
                                        <ItemTemplate>
                                             ...
                                             <asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%#Eval("FAQCategoryId")%>' OnClick="lnkDelete_Click">
