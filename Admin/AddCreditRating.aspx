<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="AddCreditRating.aspx.cs" Inherits="Admin_AddCreditRating" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">ADD CREDIT RATING</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">CREDIT RATING</a></li>
                                        <li class="breadcrumb-item active">ADD CREDIT RATING</li>
                                    </ol>
                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <asp:TextBox ID ="txtTags" runat="server"  type="text" class="form-control" placeholder="Credit Rating"></asp:TextBox>
                                                    </div>
                                                </div>
            ...
            <asp:LinkButton ID="lnkAdd" runat="server" CssClass="btn btn-primary" OnClick="lnkAdd_Click" >Add Credit Rating</asp:LinkButton>
                            ...
                            <div class="col-md-12" runat="server" id="Div3">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Credit Rating" HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <ItemTemplate>
                                              <asp:CheckBox ID="chkIsActive"  runat="server" Checked='<%#Eval("IsActive")%>' ToolTip='<%#Eval("CreditRatingId")%>'
                                                        OnCheckedChanged="chkIsActive_CheckedChanged" AutoPostBack="true" />
                                 <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%#Eval("CreditRatingId")%>' OnClick="lnkEdit_Click">
                                        ...
                                        <ItemTemplate>
                                             <asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%#Eval("CreditRatingId")%>' OnClick="lnkDelete_Click">
