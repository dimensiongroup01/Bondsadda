<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ViewBookedSold.aspx.cs" Inherits="Admin_ViewBookedSold" %>
            ...
            <div class="page-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">VIEW BOOKED/SOLD</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">BOOKED/SOLD</a></li>
                                        <li class="breadcrumb-item active">VIEW BOOKED/SOLD</li>
                                    </ol>
                                </div>
                    ...
                    <div class="row">
                                        ...
                                        <div action="javascript:void(0);">
                                            <div class="row">
                                                ...
                                                <asp:DropDownList ID="ddlMobile" runat="server" CssClass="form-control chosen">
                                                    ...
                                                    <asp:ListItem Value="9874563210">9874563210</asp:ListItem>
                                                    <asp:ListItem Value="9632587410">9632587410</asp:ListItem>
                                                </asp:DropDownList>
                                                    </div>
                                                </div>
                        ...
                        <asp:DropDownList ID="ddlEmail" runat="server" CssClass="form-control chosen">
                            <asp:ListItem Value="" Selected="True">Choose One</asp:ListItem>
                            <asp:ListItem Value="s@gmail.com">s@gmail.com</asp:ListItem>
                            <asp:ListItem Value="a@gmail.com">a@gmail.com</asp:ListItem>
                        </asp:DropDownList>
