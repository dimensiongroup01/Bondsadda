<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="AddTags.aspx.cs" Inherits="Admin_AddTags" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <asp:TextBox ID ="txtTags" runat="server"  type="text" class="form-control" placeholder="Tag"></asp:TextBox>
                                                    </div>
                                                </div>
            ...
            <asp:LinkButton ID="lnkAdd" runat="server" CssClass="btn btn-primary" OnClick="lnkAdd_Click" >Add Tags</asp:LinkButton>
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="col-md-12" runat="server" id="Div3">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Tags Head" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                        ...
                                        <ItemTemplate>
                                              <asp:CheckBox ID="chkIsActive"  runat="server" Checked='<%#Eval("IsActive")%>' ToolTip='<%#Eval("TagsId")%>'
                                                        OnCheckedChanged="chkIsActive_CheckedChanged" AutoPostBack="true" />
                                 <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%#Eval("TagsId")%>' OnClick="lnkEdit_Click">
                                        ...
                                        <ItemTemplate>
                                             ...
                                             <asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%#Eval("TagsId")%>' OnClick="lnkDelete_Click">
