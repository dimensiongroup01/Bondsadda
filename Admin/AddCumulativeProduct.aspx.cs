...
public partial class Admin_AddCumulativeProduct : System.Web.UI.Page
{
    ...
    {
        ddlSecurity.DataSource = dl.Get_SecurityDetails("Cumulative");
        ddlSecurity.DataTextField = "Security";
        ddlSecurity.DataValueField = "Security";
        ddlSecurity.DataBind();
        ddlSecurity.Items.Insert(0, new ListItem("Choose one", ""));
    }
    private void BindData()
    {
        ...
        grdData.DataSource = dl.get_ProductsCumulativeFilter(null, null, null,Security,isin, null);
        grdData.DataBind();
    }
    ...
    protected void lnkAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            int IId = dl.add_Products(null, ddlSubCategory.SelectedValue, txtISIN.Text,txtProduct.Text, txtProductName.Text, txtCouponRate.Text, txtsecure.Text, txtPutCallDate.Text, txtCallDate.Text, ddlGuaranteedBy.Text, txtMaturitydate.Text, "6", txtIPDate.Text, txtPrice.Text, txtYTCYIELD.Text, txtYTM.Text, txtFaceValue.Text, filePath, FilePath, "Cumulative", MemoPath,txtDescription.Text, GetUserLoggedIn());
            if (IId != 0)
            {
        ...
        {
            dl.update_Products(ViewState["Id"].ToString(), ddlSubCategory.SelectedValue, txtISIN.Text, txtProductName.Text,txtProduct.Text, txtCouponRate.Text, txtsecure.Text, txtPutCallDate.Text, txtCallDate.Text, ddlGuaranteedBy.Text, txtMaturitydate.Text, "6", txtIPDate.Text, txtPrice.Text, txtYTCYIELD.Text, txtYTM.Text, txtFaceValue.Text, filePath, FilePath, MemoPath, "Cumulative",txtDescription.Text, GetUserLoggedIn());
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = dl.get_ProductsCumulative(lnkEdit.CommandArgument, null, null, null);
    ...
    protected void grdData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            grdData.Columns[22].Visible = Convert.ToBoolean(dtsubpermission1.Rows[0]["CanUpdate"]);
            grdData.Columns[22].Visible = Convert.ToBoolean(dtsubpermission1.Rows[0]["CanUpdate"]);
            grdData.Columns[23].Visible = Convert.ToBoolean(dtsubpermission1.Rows[0]["CanDelete"]);
