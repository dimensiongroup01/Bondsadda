<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="AddBlogCategory.aspx.cs" Inherits="Admin_AddBlogCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-content">
                                    ...
                                    <div class="live-preview">
                                        <div action="javascript:void(0);">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="firstNameinput" class="form-label">Blog Category*</label>
                                                        <asp:TextBox ID ="txtBlogcategory" runat="server" class="form-control" placeholder="Blog Category"></asp:TextBox>
                                                    </div>
                                                </div>
            ...
            <asp:LinkButton ID="lnkAdd" runat="server" CssClass="btn btn-primary" OnClick="lnkAdd_Click" >Add BlogCategory</asp:LinkButton>
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="col-md-12" runat="server" id="Div3">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Blog Category" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                        ...
                                        <ItemTemplate>
                                              <asp:CheckBox ID="chkIsActive"  runat="server" Checked='<%#Eval("IsActive")%>' ToolTip='<%#Eval("BlogCategoryId")%>'
                                        ...
                                        <ItemTemplate>
                                 <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%#Eval("BlogCategoryId")%>' OnClick="lnkEdit_Click">
                                        ...
                                        <ItemTemplate>
                                             ...
                                             <asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%#Eval("BlogCategoryId")%>' OnClick="lnkDelete_Click">
