<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="AdharDetails.aspx.cs" Inherits="Admin_AdharDetails" %>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">ADHAR DETAILS</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">ADHAR DETAILS</a></li>
                                        <li class="breadcrumb-item active">ADHAR DETAILS</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="col-md-12" runat="server" id="Div3">
                                ...
                                <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="Adhar Number" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                           
                                            <%#Eval("AdharNumber")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                <asp:TemplateField HeaderText="Adhar Status" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
