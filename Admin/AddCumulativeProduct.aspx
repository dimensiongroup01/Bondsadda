<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="AddCumulativeProduct.aspx.cs" Inherits="Admin_AddCumulativeProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">ADD CUMULATIVE PRODUCTS</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">CUMULATIVE PRODUCTS</a></li>
                                        <li class="breadcrumb-item active">ADD CUMULATIVE PRODUCTS</li>
                                    </ol>
                                </div>
                    ...
                    <asp:Panel ID ="pnlAdd" runat="server">
                      ...
                      <asp:HiddenField ID="hfImageFilePath" runat="server" />
                                           ...
                                           <asp:TextBox ID ="txtCouponRate" runat="server" class="form-control" AutoPostBack="true" placeholder="Enter Coupon Rate"></asp:TextBox>
                                           ...
                                           <asp:TextBox ID ="txtPutCallDate" runat="server" class="form-control datepicker"></asp:TextBox>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="firstNameinput" class="form-label">CallDate</label>
                                           <asp:TextBox ID ="txtCallDate" runat="server" class="form-control datepicker"></asp:TextBox>
                                               ...
                                               <asp:TextBox ID="ddlGuaranteedBy" runat="server" CssClass="form-control"></asp:TextBox>
                                             <%--  <asp:DropDownList ID="ddlGuaranteedBy" runat="server" CssClass="form-control">
                                                   <asp:ListItem Value="" Selected="True">Choose one</asp:ListItem>
        ...
        <asp:TextBox ID ="txtIPDate" runat="server" class="form-control datepicker" placeholder="IP Date"></asp:TextBox>
        ...
        <asp:TextBox ID ="txtPrice" runat="server" class="form-control" AutoPostBack="true" placeholder="Enter Coupon Rate"></asp:TextBox>
 ...
 <asp:ListBox ID="ddlTags" runat="server" CssClass="form-control js-example-basic-multiple" SelectionMode="Multiple" ></asp:ListBox>
    ...
    <asp:FileUpload ID="FileUpload2" runat="server" CssClass="form-control"/>
                      ...
                      <asp:HiddenField ID="hfIconFilePath" runat="server" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="ForminputState" class="form-label">Momerandum File</label>
    <asp:FileUpload ID="FileUpload3" runat="server" CssClass="form-control"/>
                                                        <progress id="MemorandumFile" style="display: none"></progress>
                      <asp:HiddenField ID="hfMemorandum" runat="server" />
                    ...
                    <asp:Panel ID ="pnlView" runat="server">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="col-md-12" runat="server" id="Div3">
                                ...
                                EmptyDataText="No Records Available..!!!" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataRowStyle-VerticalAlign="Middle" EmptyDataRowStyle-Height="320" AllowPaging="true" OnPageIndexChanging="grdData_PageIndexChanging" CellPadding="4" PageSize="50">
