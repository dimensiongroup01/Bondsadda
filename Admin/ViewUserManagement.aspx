<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ViewUserManagement.aspx.cs" Inherits="Admin_ViewUserManagement" %>
...
<%--                                 <asp:TemplateField HeaderText="Role" HeaderStyle-HorizontalAlign="Left">
       ...
       <asp:TemplateField  ItemStyle-HorizontalAlign="Center" HeaderText="Action" HeaderStyle-CssClass="hidecolum" ItemStyle-CssClass="hidecolum" HeaderStyle-HorizontalAlign="Left">
                            ...
                            <a href="UserManagement.aspx?oId=<%#Eval("UserId") %>"> <i class="material-icons">border_color</i></a>
