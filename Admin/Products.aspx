...
<%--    <link href="https://themesbrand.com/velzon/html/galaxy/assets/css/app.min.css" rel="stylesheet" type="text/css" />--%>
 <%--     <link rel="stylesheet" href="https://cdn.ckeditor.com/4.16.2/standard-all/ckeditor.css">--%>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">ADD BULLET PRODUCTS</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">BULLET PRODUCTS</a></li>
                                        <li class="breadcrumb-item active">ADD BULLET PRODUCTS</li>
                                    </ol>
                                </div>
                    ...
                    <asp:Panel ID ="pnlView" runat="server">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="col-md-12" runat="server" id="Div3">
                                ...
                                EmptyDataText="No Records Available..!!!" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataRowStyle-VerticalAlign="Middle" EmptyDataRowStyle-Height="320" OnPageIndexChanging="grdData_PageIndexChanging" CellPadding="4" PageSize="50" AllowPaging="true">
...
<%--<script src="../assets/js/pages/select2.init.js"></script>
    ...
    <link href="../dist/chosen_v1.8.7/chosen.min.css" rel="stylesheet" />--%>
            <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
    <script src="../assets/js/pages/select2.init.js"></script>
