<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="EnqueryForm.aspx.cs" Inherits="Admin_EnqueryForm" %>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">VIEW ENQUIRY FORM</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">ENQUIRY FORM</a></li>
                                    <li class="breadcrumb-item active">VIEW ENQUIRY FORM</li>
                                </ol>
                            </div>
                            ...
                            <Columns>
                               ...
                               <asp:TemplateField HeaderText="Date" HeaderStyle-HorizontalAlign="Left">
                                ...
                                <asp:TemplateField HeaderText="First Name" HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                       <div id="divGridViewScroll" style="width:400px; height:100px; overflow: auto">
                                        <%#Eval("Message")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
