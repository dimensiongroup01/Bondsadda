<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ViewCumulativeCloseDeal.aspx.cs" Inherits="Admin_ViewCumulativeCloseDeal" %>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">CUMULATIVE CLOSE DEAL CHART</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">CUMULATIVE CLOSE DEAL CHART</a></li>
                                        <li class="breadcrumb-item active">CUMULATIVE CLOSE DEAL CHART</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-xl-12">
                            ...
                            <asp:TemplateField HeaderText="YTM" HeaderStyle-HorizontalAlign="Left">
                             ...
                             <asp:TemplateField HeaderText="Face Value For Bond" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                           <asp:HiddenField ID ="hfFaceBond" runat="server" Value='<%#Eval("FacevalueForBond") %>' />
                              ...
                              <asp:TemplateField HeaderText="Face Value For Deal" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                           <asp:HiddenField ID ="hfDealValue" runat="server" Value='<%#Eval("DFaceValueForDeal") %>' />
