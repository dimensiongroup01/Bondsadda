<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ImportBulletProduct.aspx.cs" Inherits="Admin_ImportBuutetProduct" %>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">BULLET PRODUCT IMPORT</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">BULLET PRODUCT IMPORT</a></li>
                                        <li class="breadcrumb-item active">BULLET PRODUCT IMPORT</li>
                                    </ol>
                                </div>
                    ...
                    <asp:Panel ID ="pnlAdd" runat="server">
                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                ...
                                <a style="margin-left: 90%" href="sample.xlsx" runat="server" target="_blank" alt="Semple xsl Sheet">
