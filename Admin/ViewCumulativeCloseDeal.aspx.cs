...
public partial class Admin_ViewCumulativeCloseDeal : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        grdData.DataSource = dl.get_CloseDealCumulative(null, null, null, null, null);
        grdData.DataBind();
    }
    ...
    protected void grdData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            HiddenField hfFaceBond = e.Row.FindControl("hfFaceBond") as HiddenField;
            HiddenField hfDealValue = e.Row.FindControl("hfDealValue") as HiddenField;
            HiddenField hfCloseDeal = e.Row.FindControl("hfCloseDeal") as HiddenField;
            Label lblQunatity = e.Row.FindControl("lblQuantity") as Label;
            ...
            grdItems.DataBind();
            float bond = float.Parse(hfFaceBond.Value);
            float deal = float.Parse(hfDealValue.Value);
            float Quantity = deal / bond;
            lblQunatity.Text = Quantity.ToString();
