<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ViewStaggered.aspx.cs" Inherits="Admin_ViewBulletProducts" %>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">VIEW STAGGERED PRODUCT</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">STAGGERED PRODUCT</a></li>
                                    <li class="breadcrumb-item active">STAGGERED PRODUCT</li>
                                </ol>
                            </div>
