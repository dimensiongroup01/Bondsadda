...
public partial class Pan_Kra_Verifications : System.Web.UI.Page
{
    DAL dl = new DAL();
    ...
    private void SaveVerificationData(JObject jsonResponse, string accessToken, string tokenType, string expiry)
    {
        ...
        else if (code == "200")
        {
            ...
            if (data != "" || data != null)
            {
                lblPanNumber.Text = "PAN Number : " + pannumber;
                lblpankrastatus.Text = "PAN KRA Status : " + panKraStatus;
                lblkradescription.Text = "PAN KRA Description : " + panKraStatusDescription;
                lblkrastatus.Text = "KRA Status :" + kraStatus;
                lblkraagency.Text = "KRA Agency :" + panKraAgency;
            }
