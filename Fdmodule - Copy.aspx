<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="Fdmodule - Copy.aspx.cs" Inherits="Fdmodule" %>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-2">
                                ...
                                <asp:TextBox ID="txtName" runat="server" CssClass="form-control"   ReadOnly="false" placeholder="Enter your full name" />
                            </div>
                            <div class="mb-2">
                                <label for="txtEmail">Email</label>
                                <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control"   ReadOnly="false" TextMode="Email" placeholder="example@email.com" />
                            </div>
                            <div class="mb-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-2">
                                ...
                                <asp:RequiredFieldValidator 
                                    ID="rfvFDType" 
                                    runat="server" 
                                    ControlToValidate="ddlFDType"
                                    InitialValue=""
                                    ErrorMessage="FD Type is required." 
