    ...
    <section class="signup-page">
            <div class="container">
                <div class="row border">
                    <div class="col-md-6">
                        <a  href="<%=ResolveUrl("~")%>Index" class="text-dark btn box"><i class="fa-solid fa-house"></i> Go Back to Home</a><br /><br />
                    ...
                    <div class="col-md-5 py-5">
                        ...
                        <asp:UpdatePanel ID ="uPanel" runat="server">
                            ...
                            <div class="form-group" runat="server" id="vmobile">
                                ...
                                <asp:LinkButton ID="lnkGetOTP" runat="server" CssClass="btn btn-primary" OnClick="lnkGetOTP_Click">Get OTP</asp:LinkButton>
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="exampleCheck1"><small>Remember me
