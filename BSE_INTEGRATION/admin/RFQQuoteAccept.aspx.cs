...
public partial class BSE_INTEGRATION_RFQQuoteAccept : System.Web.UI.Page
{
    ...
    private async Task<string> RFQQuoteAccept()
    {
            ...
            RFQQuoteAccept = new[]
                         {
                            new
                            {
                                ...
                                buyerbrokercode = txtBuyerBrokerCode.Text.Trim(),
                                responderreferencenumber = txtResponderReferenceNumber.Text.Trim(),
                                respondercomment = txtResponderComment.Text.Trim(),
                                rfqquoteaccept = rblRFQQuoteAccept.SelectedValue,
        ...
        return await SendRFQQuoteAccept(token, jsonPayload, password, participantId, dealerId);
    }




    private async Task<string> SendRFQQuoteAccept(string token, string jsonPayload, string password, string participantid, string dealerid)
    {
        try
        {
